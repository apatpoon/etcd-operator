...
import (
	...
	"github.com/Simonpoon93/etcd-operator/api/v1alpha1"
...
var (
	EtcdClusterLabelKey       = "etcd.oschina.cn/cluster"
...
func MutateHeadlessSvc(cluster *v1alpha1.EtcdCluster, svc *corev1.Service) {
	...
	svc.Spec = corev1.ServiceSpec{
		...
		// Publish IP even Pod isn't Ready
		PublishNotReadyAddresses: true,
	}
}
